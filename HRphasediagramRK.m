...
for i=1:50000
    ...
    dxarray = [dxarray, dxdt(t,x0,y0,z0)];
    dyarray = [dyarray, dydt(t,x0,y0,z0)];
    dzarray = [dzarray, dzdt(t,x0,y0,z0)];
...
p = plot(xarray,dxarray,'-',yarray,dyarray,':',zarray,dzarray,'-.');
set(p(1), 'linewidth', 3);
set(p(2), 'linewidth', 3);
set(p(3), 'linewidth', 3);
...
thelegend27 = legend('$x_dot(t)$','$y_dot(t)$', '$z_dot(t)$', 'Interpreter','latex', 'location', 'southwest');
